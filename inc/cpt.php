...
function custom_taxonomy() {
	...
	foreach ( list_taxonomies() as $slug => $name ) {
		...
		register_taxonomy( $slug. '_used-listings', array( 'used-listings'), $args );
...
function listings() {
	...
	$labels = array(
		'name'                  => _x( 'Listings used', 'Post Type General Name', 'shopperexpress' ),
		'singular_name'         => _x( 'Listings used', 'Post Type Singular Name', 'shopperexpress' ),
		'menu_name'             => __( 'Listings used', 'shopperexpress' ),
		'name_admin_bar'        => __( 'Listings used', 'shopperexpress' ),
		'archives'              => __( 'Item Archives', 'shopperexpress' ),
		'attributes'            => __( 'Item Attributes', 'shopperexpress' ),
		'parent_item_colon'     => __( 'Parent Item:', 'shopperexpress' ),
		'all_items'             => __( 'All Listings', 'shopperexpress' ),
	...
	$args = array(
		'label'                 => __( 'Listings used', 'shopperexpress' ),
		'description'           => __( 'Listings Description', 'shopperexpress' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'revisions' ),
		'taxonomies'            => list_taxonomies(),
	...
	$args['rewrite'] = array('slug' => 'used-listings','with_front' => true);
	
	register_post_type( 'used-listings', $args );
