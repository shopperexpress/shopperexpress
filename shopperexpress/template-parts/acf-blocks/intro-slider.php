 ...
 *
 * Title: Intro Slider
 * Description: Hero slider pulling from offers CPT and/or manually added slides.
 * Keywords: hero slider intro offers
...
get_template_part(
	...
	array(
		...
		'hide_search_form'   => get_field( 'hide_search_form' ),
