<?php
/**
 * Shared: Text & Video Slider
 *
 * @package ShopperExpress
 *
 * @param array $args {
 *   @type string $sort_offers_by   Sort key: date|payment_lowest|payment_highest|priority.
 ...
 * shared template — they are too tightly coupled to live elsewhere.
 */
