...
if ($image = get_sub_field('image')) :
    ...
    ?>
    <div class="section-full-width-image<?php if (get_sub_field('remove_paddings')) : ?> py-0<?php endif; ?>">
        <div class="container">
            <?php ?>
            <div class="img-holder">
                <?php if ( $url = get_sub_field('url') ) : ?>
                    <a href="<?php echo esc_url($url); ?>"<?php if(get_sub_field('open_in_new_tab')) : ?> target="_blank"<?php endif; ?>>
                        <picture>
