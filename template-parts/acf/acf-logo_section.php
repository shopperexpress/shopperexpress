...
if ( have_rows('logos') ) :
	?>
	<section class="section-location"<?php if($padding) : ?> style="padding: 0;"<?php endif; ?>>
		<div class="container text-center">
			...
			<ul class="location-logos <?php echo 'location-logos--columns-'.$logos_per_row; ?>">
				...
				while ( have_rows('logos') ) : the_row();
					...
					?>
					<li>
						<a href="<?php the_sub_field('link') ?>" <?php echo $new_tab; ?> aria-label="<?php echo sprintf( esc_html__( 'Read more about %s', 'shopperexpress' ), $alt ); ?>" <?php if ($logos_backgorund) echo 'style="background-color:'.$logos_backgorund.';"' ?>>
