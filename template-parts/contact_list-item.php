...
if ( $icon || $title || $link ) :
    if ( get_sub_field( 'show_drop' ) != true ) :
        ?>
        <li><?php display_svg_icon(get_sub_field('svg_icon')); ?><?php if ( $title ) : ?><span><?php echo $title; ?></span><?php endif; if ( $link ) echo App\the_acf_button( $link ); ?></li>
    <?php else : ?>
