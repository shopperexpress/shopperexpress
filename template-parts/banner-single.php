...
if (get_field('show_banner_single-' . $post_type, 'options') == true) :
    ...
    $items = [];
    while (have_rows('banner_single-' . $post_type . '_banner_slider_vdp', 'options')) : the_row();
        $show = true;
        ...
        <div class="visual visual--banner" data-banner>
            <div class="visual-holder">
                <div class="visual-slider visual-slider-srp slick-item" data-speed="500" data-autoplay-speed="5000">
                    ...
                    ?>
                        <div class="slide">
                            <a href="<?php echo esc_url($landing_page_url); ?>" aria-label="<?php echo esc_attr($alt_text); ?>" <?php if ($open_in_new_tab) : ?> target="_blank" <?php endif; ?>>
