...
}elseif( in_array( get_post_type( $_id ), [ 'conditional-offers', 'lease-offers', 'finance-offers' ] ) ){
                    ...
                    <div class="col-lg-3 item-col item-left">
                        ...
                        if ( is_singular() ) :
                            ...
                            switch ( get_post_type() ) {
                                ...
                                case 'research':
                                if ( !empty($model) ) {
                                    $link_btn = esc_url(add_query_arg(['model-research[]' => $model[0]->slug ],  get_post_type_archive_link('research')));
                ...
                <div class="row">
                    <div class="col-md-10 col-lg-9 m-auto text-center">
                        <div class="text-holder">
                            ...
                            <h1><?php if( is_single() ): echo $make . ' ' . $model; else: the_field( 'title' , 'options' ); endif; ?></h1>
                        </div>
                    </div>
                    <div class="col-12 btn-holder text-center">
                        <?php
