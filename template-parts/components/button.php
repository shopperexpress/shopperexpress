...
if ($show) :
    ...
    if ($background_color = get_sub_field('background_color')) $style .= 'background-color: ' . $background_color . '; border-color: ' . $background_color . ';';
    if ($text_color = get_sub_field('text_color')) $style .= 'color: ' . $text_color . ';';
    if ($font_size) $style .= 'font-size: ' . $font_size . 'px;';
    if ($font_styling) $style .= 'font-family: ' . $font_styling . ';';
...
?>
    ...
    <button
        type="button"
        <?php if (!is_single()) echo 'data-post="' . $post_id . '"'; ?>
        class="btn btn-primary btn-custom btn-block <?php echo $animation; ?>"
        <?php if ($form_id = get_sub_field('form_id')) : ?> data-form-id="<?php echo $form_id; ?>" <?php endif; ?>
        <?php if (!$link) : ?>
